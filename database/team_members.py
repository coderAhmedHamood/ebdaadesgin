...
team_members = [
  ...
  "bio": "عبدالله أبوالغيث متخصص في التسويق الرقمي بخبرة تزيد عن 6 سنوات، يمتلك القدرة على وضع استراتيجيات نمو فعّالة وإدارة الحملات الرقمية على مختلف المنصات. يركز على تحسين الأداء وزيادة الحصة السوقية مع قيادة فرق العمل بكفاءة لضمان تحقيق نتائج ملموسة.",
  "email": "abdullah@example.com",
  "phone": "+966500000000",
  "linkedin": "https://www.linkedin.com/in/abdullah-abualgheith",
  "image": "/uploads/1.jpg",
  "experience": "6 سنوات",
  "specialty": "إدارة الحملات الرقمية، التسويق الإلكتروني للمتاجر والمنصات، التحول الرقمي للعلامات التجارية",
  "skills": [
...
,
 {
  "id": "2",
  "name": "أحمد العُمري",
  "position": "مهندس حلول برمجية",
  "department": "تطوير المواقع والأنظمة المتكاملة",
  "bio": "أحمد العُمري مهندس حلول برمجية بخبرة 5 سنوات، متخصص في تصميم وبناء أنظمة متكاملة وتحويل العمليات المعقدة إلى حلول عملية. يمتلك القدرة على إدارة فرق التطوير وضمان تسليم المشاريع بجودة عالية، مع تقديم حلول تقنية مبتكرة تلبي احتياجات العملاء بكفاءة.",
...
"bio": "أصيل الجهلاني مهندس برمجيات بخبرة واسعة في تطوير أنظمة ERP وحلول SaaS والتجارة الإلكترونية. متخصص في تحويل الأفكار إلى حلول عملية وفعالة، مع القدرة على تحسين سير العمل وأتمتة العمليات وزيادة الكفاءة، وإدارة فرق التطوير لضمان تسليم المشاريع بجودة عالية وتجربة مستخدم متميزة.",
"phone": "+967715811982",
...
"experience": "6 سنوات",
"specialty": "تطوير أنظمة ERP وحلول SaaS والتجارة الإلكترونية، تصميم قواعد البيانات، إدارة فرق التطوير، الربط والتكامل مع الأنظمة والخدمات الخارجية",
"achievements": [

...
// Schema type to match backend / database
...
const PackagesManager: React.FC = () => {
  ...
  const [form, setForm] = useState<PackageItem>(emptyPkg);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-2xl bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-6" dir="rtl">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold">{editingId ? 'تعديل باقة' : 'إضافة باقة'}</h2>

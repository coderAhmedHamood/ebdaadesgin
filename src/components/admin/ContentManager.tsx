  ...
  const [content, setContent] = useState<Record<string, ContentSection[]>>({
    homepage: [
      ...
      },
      {
        ...
        name: 'العنوان الفرعي',
        type: 'rich-text',
        content: 'إبداع ديزاين - شريكك الموثوق في التميز الرقمي، نحول رؤيتك إلى واقع رقمي مبهر'
      },
      {
        id: 'hero-image',
      ...
      },
      {
        ...
        type: 'text',
        content: 'لماذا تختار إبداع ديزاين؟'
      },
      {
        id: 'why-choose-desc',
      ...
      },
      {
        ...
        type: 'rich-text',
        content: 'انضم إلى مئات العملاء الراضين الذين يثقون بإبداع ديزاين لاحتياجاتهم الرقمية. دعنا نحول مشروعك إلى واقع بخبرتنا والتزامنا بالتميز.'
      }
    ],
    about: [
      {
    ...
    testimonials: [
      ...
      },
      {
        ...
        type: 'text',
        content: 'اكتشف ما يقوله عملاؤنا عن تجربتهم مع إبداع ديزاين'
      },
      {
        ...
        items: [
          {
            ...
            rating: 5,
            testimonial: 'تجاوزت إبداع ديزاين توقعاتنا في كل جانب من جوانب مشروع موقعنا الإلكتروني. اهتمامهم بالتفاصيل والتسليم في الوقت المحدد والجودة الاستثنائية جعلتهم شريكنا المفضل في التصميم الرقمي.',
        ...
        items: [
          {
            id: 1,
            category: 'general',
            question: 'ما هي أنواع المشاريع الرقمية التي تتعامل معها إبداع ديزاين؟',
            answer: 'تتخصص إبداع ديزاين في مجموعة واسعة من المشاريع الرقمية بما في ذلك المواقع التجارية والمتاجر الإلكترونية والتطبيقات المحمولة ومواقع الشركات والمدونات الشخصية.'
          },
          {
            id: 2,
            category: 'general',
            question: 'منذ متى تعمل إبداع ديزاين في السوق؟',
            answer: 'تخدم إبداع ديزاين العملاء في العالم العربي لأكثر من 5 أعوام منذ تأسيسها في عام 2019.'
          }
        ]
      }
    ],
    ...
    leadership: [
      ...
      },
      {
        ...
        type: 'text',
        content: 'اكتشف الرؤية والقيم التي تقود إبداع ديزاين نحو التميز'
      }
    ]
  });
